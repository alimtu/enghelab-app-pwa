...
export default function InstallPrompt({ onInstall }) {
  ...
  // z-45 keeps this below the login sheet (z-50) so it can't cover the sign-in form.
  return (
    <div className="fixed bottom-6 inset-x-0 z-45 p-3 safe-bottom">
      <div className="mx-auto max-w-md bg-surface border border-stroke-soft rounded-2xl shadow-xl px-4 py-3 flex items-center gap-3">
