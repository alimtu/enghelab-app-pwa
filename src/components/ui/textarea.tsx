...
function Textarea({ className, onChange, ...props }: React.ComponentProps<'textarea'>) {
  ...
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        'placeholder:text-grey-400 flex min-h-[80px] w-full rounded-lg border border-stroke bg-surface px-3 py-2.5 text-sm shadow-xs transition-all outline-none resize-none',
