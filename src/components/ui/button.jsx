  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none cursor-pointer focus-visible:ring-2 focus-visible:ring-primary-300 focus-visible:ring-offset-2 aria-invalid:ring-2 aria-invalid:ring-danger-200 aria-invalid:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-stroke bg-surface shadow-xs hover:bg-grey-50 hover:border-grey-300 active:scale-[0.98] focus-visible:border-primary-400 focus-visible:ring-primary-200 focus-visible:ring-offset-2',
        secondary:
          'bg-grey-100 text-grey-800 shadow-xs hover:bg-grey-150 active:scale-[0.98] focus-visible:ring-grey-500 focus-visible:ring-offset-2',
        ghost:
          'hover:bg-grey-50 active:scale-[0.98] focus-visible:bg-grey-50 focus-visible:ring-grey-500 focus-visible:ring-offset-2',
        link:
