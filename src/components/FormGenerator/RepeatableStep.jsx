  ...
  return (
    <div className="space-y-4">
      {fields.map((field, index) => (
        <div
          key={field.id}
          className="rounded-xl border border-stroke-soft bg-surface overflow-hidden"
        >
          <div className="flex items-center justify-between bg-grey-25 px-3 py-2 border-b border-stroke-soft">
