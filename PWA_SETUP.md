...
## اپلیکیشن دانشگاه جامع انقلاب اسلامی - Progressive Web App

This document describes the PWA (Progressive Web App) implementation for enghelab-app.
...
- **Name**: اپلیکیشن دانشگاه جامع انقلاب اسلامی
