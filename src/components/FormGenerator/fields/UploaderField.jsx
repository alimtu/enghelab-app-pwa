...
function FilePreview({ file, localUrl, type, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={onClose}>
      <div className="relative max-w-full max-h-[85vh] bg-surface rounded-xl overflow-hidden shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <button
          type="button"
          onClick={onClose}
      ...
      render={({ field, fieldState }) => {
        ...
        return (
          <div>
            ...
            {section.placeholder && (
              <p className="text-[11px] text-grey-500 mt-0.5">{section.placeholder}</p>
            )}
            ...
            {!localFile && !hasValue ? (
              !isOnline ? (
                <div className="mt-1.5 flex w-full flex-col items-center gap-2 rounded-lg border border-dashed border-stroke bg-grey-50 px-4 py-5 text-grey-400">
                ...
                <button
                  ...
                  className={`mt-1.5 flex w-full flex-col items-center gap-2 rounded-lg border border-dashed px-4 py-5 text-grey-400 transition-colors hover:border-primary-300 hover:text-primary-500 ${
                    fieldState.error ? 'border-danger-400' : 'border-stroke'
                  }`}
                >
              ...
              <div className="mt-1.5 rounded-lg border border-stroke-soft overflow-hidden">
                ...
                {section.type === 24 && localUrl && (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="size-10 rounded-full bg-surface/80 flex items-center justify-center group-hover:bg-surface transition-colors">
