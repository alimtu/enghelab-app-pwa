  ...
  return (
    <div className="py-16 px-4 size-full flex justify-center items-center">
      <div className="text-center max-w-sm space-y-5">
        {/* Icon */}
        <div className="mx-auto w-20 h-20 bg-danger-50 rounded-2xl flex items-center justify-center ring-1 ring-danger-100">
          {isNetwork ? (
            <WifiOff className="h-9 w-9 text-danger-500" />
          ) : (
        ...
        <div className="space-y-2">
          <h2 className="text-lg font-bold text-grey-900">خطا در دریافت اطلاعات</h2>
