...
const FooterLink = ({ link, children }) => {
  const baseClasses =
    'group flex items-center gap-2 text-white hover:text-accent-200 transition-all duration-300 hover:scale-105';
...
const UpperFooter = ({ links = DEFAULT_LINKS }) => {
  ...
  return (
    <footer className="w-full bg-primary-600 py-6 lg:py-8 px-6 lg:px-8 mt-5">
