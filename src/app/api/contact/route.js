...
export async function POST(request) {
  try {
    ...
    const mailOptions = {
      from: emailUser,
      to: 'admin@cuir.ac.ir',
      subject: `پیام جدید از وب‌سایت دانشگاه جامع انقلاب اسلامی: ${subject}`,
      html: `
        <div style="font-family: 'Tahoma', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px;">
          <div style="background: white; padding: 30px; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
            <div style="text-align: center; margin-bottom: 30px;">
              <h1 style="color: #4f46e5; margin: 0; font-size: 28px;">پیام جدید از وب‌سایت دانشگاه جامع انقلاب اسلامی</h1>
            ...
            <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e2e8f0;">
              <p style="color: #64748b; margin: 0; font-size: 14px;">
                این پیام از طریق فرم تماس وب‌سایت دانشگاه جامع انقلاب اسلامی ارسال شده است
              </p>
      ...
      `,
      text: `
پیام جدید از وب‌سایت دانشگاه جامع انقلاب اسلامی
