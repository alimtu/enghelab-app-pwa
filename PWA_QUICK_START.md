...
Your PWA (Progressive Web App) has been successfully configured for enghelab-app (اپلیکیشن دانشگاه جامع انقلاب اسلامی).
...
### 2. **Icons Created** (from the university logo)
...
✅ public/manifest.json - enghelab-app branding
...
```bash
cd /Users/ali/Desktop/Project/poll-project
yarn build
yarn start
```
...
- **App Name**: اپلیکیشن دانشگاه جامع انقلاب اسلامی
