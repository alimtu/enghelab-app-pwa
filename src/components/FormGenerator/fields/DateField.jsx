            ...
            <Popover open={isOpen} onOpenChange={setIsOpen}>
              <PopoverTrigger asChild>
                <button
                  ...
                  className={`flex w-full items-center justify-between h-10 rounded-lg border bg-surface px-3 text-sm mt-1 transition-all focus:border-primary-400 focus:ring-1 focus:ring-primary-200 outline-none ${
                    fieldState.error ? 'border-danger-400 ring-1 ring-danger-100' : 'border-stroke'
                  }`}
                >
                  {field.value ? (
              ...
              <DirectionProvider dir="rtl">
                <PopoverContent className="w-auto p-3" align="start">
                  ...
                  />
                  <div className="flex justify-end pt-3 mt-3 border-t border-stroke-soft" dir="rtl">
